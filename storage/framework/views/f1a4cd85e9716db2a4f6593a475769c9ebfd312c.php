...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="<?php echo e(asset(auth()->user()->profile)); ?>" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
                <a href="<?php echo e(URL('admin/profile')); ?>" class="d-block">HNI Admin</a>
            </div>
        </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item">
                    <a href="<?php echo e(URL('admin/room')); ?>" class="nav-link <?php echo e($url_1 == 'room' ? 'active':''); ?>">
                        <i class="nav-icon fas fa-tachometer-alt"></i>
                        <p>
                            Room
                        </p>
...
<?php /**PATH /var/www/html/Room_booking/resources/views/admin/sections/left-nav.blade.php ENDPATH**/ ?>