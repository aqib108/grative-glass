				  ...
				  <div class="col-12">
				    <div class="card">
				      <div class="card-header">
					        <h3 class="card-title">
					        	<a href="<?php echo e(URL('admin/customers/create')); ?>" class="btn btn-primary"> Add New </a>
					        </h3>
				      </div>
				      <div class="card-body">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Room_booking/resources/views/admin/customer/listing.blade.php ENDPATH**/ ?>