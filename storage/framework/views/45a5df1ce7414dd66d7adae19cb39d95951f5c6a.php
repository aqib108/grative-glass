            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form id="department-form" action="<?php echo e(URL('admin/categories')); ?>" enctype="multipart/form-data" method="POST">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" placeholder="Enter Category Name" name="name" value="<?php echo e(isset($row->name) ? $row->name : ''); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="icheck-primary d-inline">
                                            Active
                                            <input type="radio" name="status" id="active-radio-status" value="1" checked <?php echo e(($row->status==1) ? 'checked' : ''); ?>>
                                ...
                                <div class="form-group text-right">
                                    <div class="col-sm-12">
                                        <a href="<?php echo e(URL('admin/categories')); ?>" class="btn btn-info mr-2"> Cancel </a>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/EStore/resources/views/admin/categories/form.blade.php ENDPATH**/ ?>