            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(URL('admin/room')); ?>">Rooms</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form id="department-form" action="<?php echo e(URL('admin/room')); ?>" enctype="multipart/form-data" method="POST">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" placeholder="Enter Room Name" name="name" value="<?php echo e(isset($row->name) ? $row->name : ''); ?>">
                                    </div>
                                </div>
                                 <div class="form-group row">
                                    <label class="col-sm-2 col-form-label"> Room Price Per Night</label>
                                    <div class="col-sm-6">
                                        <input type="number" class="form-control" placeholder="Enter Room Price" name="price" value="<?php echo e(isset($row->price) ? $row->price : ''); ?>">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Room Description</label>
                                    <div class="col-sm-6">
                                        <textarea id="summernote" name="description" ><?php echo e(isset($row->description) ? $row->description : ''); ?></textarea>
                                    </div>
                                </div>
                                ...
                                <?php if(isset($row->images) && $action=='edit'): ?>
                                <?php $tImage = asset('room-images/'.$row->images); ?>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Image</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group text-right">
                                    <div class="col-sm-12">
                                        <a href="<?php echo e(URL('admin/room')); ?>" class="btn btn-info mr-2"> Cancel </a>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Room_booking/resources/views/admin/room/form.blade.php ENDPATH**/ ?>