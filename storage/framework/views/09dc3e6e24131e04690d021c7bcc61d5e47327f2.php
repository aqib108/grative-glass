...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__shake" src="<?php echo e(asset('assets/front/images/logo.png')); ?>" alt="HNI CRM" height="60" width="60">
    </div>
...
<?php /**PATH /var/www/html/EStore/resources/views/admin/layout/app.blade.php ENDPATH**/ ?>